...
badd +1 8hourapp.rb
badd +15 app.rb
badd +12 app_service.rb
badd +1 helper.rb
badd +16 app_metadata.rb
badd +1 8hourapp-daemon-worker.rb
badd +1 8hourapp-daemon.rb
badd +1 gitrepo.rb
badd +0 content_directory.rb
args 8hourapp.rb app.rb app_service.rb helper.rb
edit 8hourapp.rb
...
20
normal! 03l
tabedit 8hourapp-daemon-worker.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
set winheight=1 winwidth=1
argglobal
edit 8hourapp-daemon-worker.rb
setlocal autoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 70 - ((49 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
normal! 0
tabedit 8hourapp-daemon.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
