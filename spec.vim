...
badd +0 spec/8hourapp_spec.rb
badd +0 spec/app_metadata_spec.rb
badd +0 spec/app_spec.rb
badd +0 spec/helper_spec.rb
args spec/8hourapp-daemon_spec.rb spec/8hourapp_spec.rb spec/app_metadata_spec.rb spec/app_spec.rb spec/helper_spec.rb
edit spec/8hourapp-daemon_spec.rb
...
silent! normal! zE
let s:l = 48 - ((47 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
normal! 0
tabedit spec/8hourapp_spec.rb
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
